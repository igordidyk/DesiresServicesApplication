...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['desires_services/src/main/resources/static/modules/moment/moment'], function (moment) {
            return factory(moment);
        });
    } else if (typeof module === 'object' && module.exports) {
        // Node / Browserify
        var moment = (typeof window != 'undefined' && typeof window.moment != 'undefined') ? window.moment : require('desires_services/src/main/resources/static/modules/moment/moment');
